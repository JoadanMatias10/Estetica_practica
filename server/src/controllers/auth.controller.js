...
import { sendTwoFactorCodeEmail } from '../services/email/email.service.js'
import {
  createTwoFactorChallenge,
  verifyTwoFactorCode,
  findUserByEmail
} from '../services/two-factor/two-factor.service.js'
import { validateLoginPayload, validateTwoFactorPayload } from '../validators/auth.validator.js'
...
export const verifyTwoFactor = async (req, res) => {
  try {
    ...
    return res.status(200).json({ message: 'Autenticación completada correctamente.' })
  } catch (error) {
